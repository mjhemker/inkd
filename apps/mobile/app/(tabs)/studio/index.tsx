...
/**
 * Studio tab landing = the artist Dashboard. Lives inside the Studio tab's
 * nested stack so the bottom tab bar stays visible; the segmented header
 * switches to Bookings / AI staff / Settings without leaving the tab.
 */
  ...
  return (
    <SafeAreaView className="flex-1 bg-surface-base" edges={["top", "bottom"]}>
      <ScrollView className="flex-1" contentContainerClassName="gap-6 px-6 py-8">
        ...
        <StudioSegments active="dashboard" />
    ...
    <Card padding="none" className="overflow-hidden">
      ...
      {sessionsQ.isLoading && artistId ? (
        ...
        <EmptyState
          ...
          action={
            <Button size="md" onPress={() => router.push("/studio/bookings")}>
              Open bookings
            </Button>
          }
        />
