...
/**
 * INKD's public marketing/landing page. Lives at /preview (not `/`) so the
 * root of getinkd.co can route straight into the app for signed-in users —
 * see app/page.tsx for the root routing logic and docs/deployment.md for the
 * documented behavior. Content/components below are unchanged from when this
 * rendered at `/`.
 */
