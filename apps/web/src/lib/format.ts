 ...
 * profile surfaces. Kept out of @inkd/core since they're presentation-only. */
...
/** Collapse weekly availability_rules into a compact human summary, e.g.
 * "Tue–Sat · 11am–7pm" or "Mon, Wed, Fri · 10am–6pm". Only looks at the open
 * rules; assumes (reasonably, for a v1 summary) a single consistent window. */
